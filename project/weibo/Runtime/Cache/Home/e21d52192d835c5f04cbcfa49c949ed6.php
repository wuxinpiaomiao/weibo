...
<head>
	...
	<link rel="stylesheet" href="/project/Public/Home/Theme/default/Css/nav.css" />
	<link rel="stylesheet" href="/project/Public/Home/Theme/default/Css/user.css" />
	<link rel="stylesheet" href="/project/Public/Home/Theme/default/Css/bottom.css" />
	...
	<script type='text/javascript' src='/project/Public/Home/Js/nav.js'></script>Home
	<script type='text/javascript' src='/project/Public/Home/Js/index.js'></script>
...
<!--==========内容主体==========-->
	...
	<div id='userinfo'>
		<div class='info-list'>
			<div class='info-face'>
				<p>
					<img src="<?php if($userinfo["face180"]): ?>/project/Uploads/Face/<?php echo ($userinfo["face180"]); else: ?>/project/Public/Home/Images/noface.gif<?php endif; ?>" width='180' height='180' alt="<?php echo ($userinfo["username"]); ?>" />
				</p>
				<ul>
					<li>
            ...
            <div class="weibo">
                ...
                <!--=====回复框=====-->
                    <div class='comment_load hidden'>
                        <img src="/project/Public/Home/Images/loading.gif">评论加载中，请稍候...
                    </div>
        	...
        	<dl>
                ...
                <?php if(is_array($follow)): foreach($follow as $key=>$v): ?><dd>
        			<a href="<?php echo U('/' . $v['uid']);?>">
        				<img src="<?php if($v["face"]): ?>/project/Uploads/Face/<?php echo ($v["face"]); else: ?>/project/Public/Home/Images/noface.gif<?php endif; ?>" alt="<?php echo ($v["username"]); ?>" width='50' height='50'/>
        			</a>
        			<p>
        				<a href="<?php echo U('/' . $v['uid']);?>"><?php echo ($v["username"]); ?></a>
        			</p>
