...
<head>
    ...
    <link rel="stylesheet" href="/project/Public/Theme/default/Css/nav.css" />
    <link rel="stylesheet" href="/project/Public/Theme/default/Css/index.css" />
    <link rel="stylesheet" href="/project/Public/Theme/default/Css/bottom.css" />
    <link rel="stylesheet" href="/project/Public/Uploadify/uploadify.css"/>
    ...
    <script type="text/javascript" src='/project/Public/Uploadify/jquery.uploadify.min.js'></script>
    <script type="text/javascript" src='/project/Public/Js/index.js'></script>
...
<!--==========自定义模版==========-->
    <div id='model' class='hidden'>
        ...
        <ul>
            <li style='background:url(/project/Public/Images/default.jpg) no-repeat;' theme='default'></li>
            <li style='background:url(/project/Public/Images/style2.jpg) no-repeat;' theme='style2'></li>
            <li style='background:url(/project/Public/Images/style3.jpg) no-repeat;' theme='style3'></li>
            <li style='background:url(/project/Public/Images/style4.jpg) no-repeat;' theme='style4'></li>
        </ul>
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        <img src="
                        <?php if($v["face"]): ?>/project/Uploads/Face/<?php echo ($v["face"]); ?>
                        <?php else: ?>
                            /project/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                    ...
                    <?php if($v['max']): ?><dd>
                            <div class='wb_img'>
                            <!--小图-->
                                <img src="/project/Uploads/Pic/<?php echo ($v["mini"]); ?>" class='mini_img'/>
                                <div class="img_tool hidden">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="/project/Uploads/Pic/<?php echo ($v["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                        </li>
                                    </ul>
                                <!--中图-->
                                    <div class="img_info"><img src="/project/Uploads/Pic/<?php echo ($v["medium"]); ?>"/></div>
                                </div>
                            </div>
                        </dd><?php endif; ?>
                    </dl>
                ...
                <!--=====回复框=====-->
                    <div class='comment_load hidden'>
                        <img src="/project/Public/Images/loading.gif">评论加载中，请稍候...
                    </div>
                        ...
                        <dd>
                            <div class="wb_turn">
                                ...
                                <?php if($v["isturn"]["max"]): ?><dd>
                                        <div class="turn_img">
                                        <!--小图-->
                                            <img src="/project/Uploads/Pic/<?php echo ($v["isturn"]["mini"]); ?>" class='turn_mini_img'/>
                                            <div class="turn_img_tool hidden">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i class='icon icon-bigpic'></i>
                                                        <a href="/project/Uploads/Pic/<?php echo ($v["isturn"]["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                                    </li>
                                                </ul>
                                            <!--中图-->
                                                <div class="turn_img_info">
                                                    <img src="/project/Uploads/Pic/<?php echo ($v["isturn"]["medium"]); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </dd><?php endif; ?>
    ...
    <dl class="user_face">
        <dt>
            <a href="<?php echo U('/' . $uid);?>">
                <img src="<?php if($face): ?>/project/Uploads/Face/<?php echo ($face); else: ?>/project/Public/Images/noface.gif<?php endif; ?>" width='80' height='80' alt="<?php echo ($username); ?>" />
            </a>
        </dt>
        <dd>
            <a href="<?php echo U('/' . $uid);?>"><?php echo ($username); ?></a>
        </dd>
    </dl>
    <ul class='num_list'>
        ...
        <li class='noborder'>
            <a href="<?php echo U('/' . $uid);?>"><strong><?php echo ($weibo); ?></strong><span>微博</span></a>
        </li>
    </ul>
</userinfo>
    <div class="maybe">
                ...
                <maybe uid='$_SESSION["uid"]'>
                    <li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('/' . $uid);?>">
                                    <img src="<?php if($face): ?>/project/Uploads/Face/<?php echo ($face); else: ?>/project/Public/Images/noface.gif<?php endif; ?>" width='30' height='30'/>
                                </a>
                            </dt>
...
<!--==========表情选择框==========-->
    <div id="phiz" class='hidden'>
        ...
        <ul>
            <li><img src="/project/Public/Images/phiz/hehe.gif" alt="呵呵" title="呵呵" /></li>
            <li><img src="/project/Public/Images/phiz/xixi.gif" alt="嘻嘻" title="嘻嘻" /></li>
            <li><img src="/project/Public/Images/phiz/haha.gif" alt="哈哈" title="哈哈" /></li>
            <li><img src="/project/Public/Images/phiz/keai.gif" alt="可爱" title="可爱" /></li>
            <li><img src="/project/Public/Images/phiz/kelian.gif" alt="可怜" title="可怜" /></li>
            <li><img src="/project/Public/Images/phiz/wabisi.gif" alt="挖鼻屎" title="挖鼻屎" /></li>
            <li><img src="/project/Public/Images/phiz/chijing.gif" alt="吃惊" title="吃惊" /></li>
            <li><img src="/project/Public/Images/phiz/haixiu.gif" alt="害羞" title="害羞" /></li>
            <li><img src="/project/Public/Images/phiz/jiyan.gif" alt="挤眼" title="挤眼" /></li>
            <li><img src="/project/Public/Images/phiz/bizui.gif" alt="闭嘴" title="闭嘴" /></li>
            <li><img src="/project/Public/Images/phiz/bishi.gif" alt="鄙视" title="鄙视" /></li>
            <li><img src="/project/Public/Images/phiz/aini.gif" alt="爱你" title="爱你" /></li>
            <li><img src="/project/Public/Images/phiz/lei.gif" alt="泪" title="泪" /></li>
            <li><img src="/project/Public/Images/phiz/touxiao.gif" alt="偷笑" title="偷笑" /></li>
            <li><img src="/project/Public/Images/phiz/qinqin.gif" alt="亲亲" title="亲亲" /></li>
            <li><img src="/project/Public/Images/phiz/shengbin.gif" alt="生病" title="生病" /></li>
            <li><img src="/project/Public/Images/phiz/taikaixin.gif" alt="太开心" title="太开心" /></li>
            <li><img src="/project/Public/Images/phiz/ldln.gif" alt="懒得理你" title="懒得理你" /></li>
            <li><img src="/project/Public/Images/phiz/youhenhen.gif" alt="右哼哼" title="右哼哼" /></li>
            <li><img src="/project/Public/Images/phiz/zuohenhen.gif" alt="左哼哼" title="左哼哼" /></li>
            <li><img src="/project/Public/Images/phiz/xiu.gif" alt="嘘" title="嘘" /></li>
            <li><img src="/project/Public/Images/phiz/shuai.gif" alt="衰" title="衰" /></li>
            <li><img src="/project/Public/Images/phiz/weiqu.gif" alt="委屈" title="委屈" /></li>
            <li><img src="/project/Public/Images/phiz/tu.gif" alt="吐" title="吐" /></li>
            <li><img src="/project/Public/Images/phiz/dahaqian.gif" alt="打哈欠" title="打哈欠" /></li>
            <li><img src="/project/Public/Images/phiz/baobao.gif" alt="抱抱" title="抱抱" /></li>
            <li><img src="/project/Public/Images/phiz/nu.gif" alt="怒" title="怒" /></li>
            <li><img src="/project/Public/Images/phiz/yiwen.gif" alt="疑问" title="疑问" /></li>
            <li><img src="/project/Public/Images/phiz/canzui.gif" alt="馋嘴" title="馋嘴" /></li>
            <li><img src="/project/Public/Images/phiz/baibai.gif" alt="拜拜" title="拜拜" /></li>
            <li><img src="/project/Public/Images/phiz/sikao.gif" alt="思考" title="思考" /></li>
            <li><img src="/project/Public/Images/phiz/han.gif" alt="汗" title="汗" /></li>
            <li><img src="/project/Public/Images/phiz/kun.gif" alt="困" title="困" /></li>
            <li><img src="/project/Public/Images/phiz/shuijiao.gif" alt="睡觉" title="睡觉" /></li>
            <li><img src="/project/Public/Images/phiz/qian.gif" alt="钱" title="钱" /></li>
            <li><img src="/project/Public/Images/phiz/shiwang.gif" alt="失望" title="失望" /></li>
            <li><img src="/project/Public/Images/phiz/ku.gif" alt="酷" title="酷" /></li>
            <li><img src="/project/Public/Images/phiz/huaxin.gif" alt="花心" title="花心" /></li>
            <li><img src="/project/Public/Images/phiz/heng.gif" alt="哼" title="哼" /></li>
            <li><img src="/project/Public/Images/phiz/guzhang.gif" alt="鼓掌" title="鼓掌" /></li>
            <li><img src="/project/Public/Images/phiz/yun.gif" alt="晕" title="晕" /></li>
            <li><img src="/project/Public/Images/phiz/beishuang.gif" alt="悲伤" title="悲伤" /></li>
            <li><img src="/project/Public/Images/phiz/zuakuang.gif" alt="抓狂" title="抓狂" /></li>
            <li><img src="/project/Public/Images/phiz/heixian.gif" alt="黑线" title="黑线" /></li>
            <li><img src="/project/Public/Images/phiz/yinxian.gif" alt="阴险" title="阴险" /></li>
            <li><img src="/project/Public/Images/phiz/numa.gif" alt="怒骂" title="怒骂" /></li>
            <li><img src="/project/Public/Images/phiz/xin.gif" alt="心" title="心" /></li>
            <li><img src="/project/Public/Images/phiz/shuangxin.gif" alt="伤心" title="伤心" /></li>
        </ul>
    </div>
<!--==========表情==========-->

<!--[if IE 6]>
    <script type="text/javascript" src="/project/Public/Js/DD_belatedPNG_0.0.8a-min.js"></script>
    <script type="text/javascript">
