...
<head>
    ...
    <link rel="stylesheet" href="/Public/Home/Theme/default/Css/edit.css" />
    ...
    <script type='text/javascript' src='/Public/Home/Js/edit.js'></script>
        ...
        <div id='right'>
            ...
            <div class='form'>
                <form action="<?php echo U('Home/UserSetting/edit');?>" method='post'>
                    <p>
                        ...
                        <input type="text" name='nickname' value='<?php echo ($user["username"]); ?>' class='input' /><span></span>
                    </p>
                    <p>
            ...
            <div class='form hidden'>
                <form action="<?php echo U('Home/UserSetting/face');?>" method='post'>
                    <div class='edit-face'>
                        <img src="
                        <?php if($user["face180"]): ?>/Public<?php echo ($user["face180"]); ?>
                        <?php else: ?>
                            /Public/Home/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
                        <p>
